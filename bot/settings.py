...
class Env(BaseSettings):
    ...
    YOUTUBE_FAST_DOWNLOAD_ENABLED: bool = True
    YOUTUBE_MIN_HEIGHT: int = 420
    YOUTUBE_MAX_HEIGHT: int = 720
    YOUTUBE_TARGET_SIZE_MB: int = 80
    YOUTUBE_CONCURRENT_FRAGMENTS: int = 4
...
YOUTUBE_FAST_DOWNLOAD_ENABLED = Env.YOUTUBE_FAST_DOWNLOAD_ENABLED
YOUTUBE_MIN_HEIGHT = max(1, Env.YOUTUBE_MIN_HEIGHT)
YOUTUBE_MAX_HEIGHT = max(YOUTUBE_MIN_HEIGHT, Env.YOUTUBE_MAX_HEIGHT)
YOUTUBE_TARGET_SIZE_MB = max(1, min(Env.YOUTUBE_TARGET_SIZE_MB, MAX_VIDEO_SIZE_MB))
YOUTUBE_TARGET_SIZE_BYTES = YOUTUBE_TARGET_SIZE_MB * 1024 * 1024
YOUTUBE_CONCURRENT_FRAGMENTS = max(1, Env.YOUTUBE_CONCURRENT_FRAGMENTS)
